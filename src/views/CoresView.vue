<template>
    <div>
        ...
        <TheCores @show_menu_lateral="handle_showHidden_menu_lateral" @editarCategoria="editarCategoriaNow"/>
...
<script>
   ...
   import TheCores from "../components/admin/TheCores.vue"
   import TheAddCores from "../components/modals/TheAddCores.vue"
