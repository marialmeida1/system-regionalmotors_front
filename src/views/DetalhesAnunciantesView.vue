<template>
    <div>
        ...
        <TheDetalhesAnunciantes @show_menu_lateral="handle_showHidden_menu_lateral"/>
...
<script>
   ...
   import TheDetalhesAnunciantes from "../components/admin/TheDetalhesAnunciantes.vue"
