<template>
    <div>
        ...
        <TheSeguranca @show_menu_lateral="handle_showHidden_menu_lateral" @editarCategoria="editarCategoriaNow"/>
...
<script>
   ...
   import TheSeguranca from "../components/admin/TheSeguranca.vue"
   import TheAddSeguranca from "../components/modals/TheAddSeguranca.vue"
