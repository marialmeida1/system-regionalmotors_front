<template>
    <div>
        ...
        <TheModelos @show_menu_lateral="handle_showHidden_menu_lateral"/>
...
<script>
   ...
   import TheModelos from "../components/admin/TheModelos.vue"
   import TheAddModelo from "../components/modals/TheAddModelo.vue"
