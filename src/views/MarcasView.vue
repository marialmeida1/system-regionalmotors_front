<template>
    <div>
        ...
        <TheMarcas @show_menu_lateral="handle_showHidden_menu_lateral"/>
...
<script>
   ...
   import TheMarcas from "../components/admin/TheMarcas.vue"
   import TheAddMarca from "../components/modals/TheAddMarca.vue"
