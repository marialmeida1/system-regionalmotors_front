              ...
              <div class="row">
                <div class="py-3" v-if="status_publicacao == 2 || status_publicacao == 5">
                  ...
                  <select v-model="status_publicacao" class="form-select">
                    <option value="2" v-if="status_publicacao !== '2'">Não</option>
                    <option value="2" v-else selected>Não</option>
                    <option value="5" v-if="status_publicacao !== '5'">Sim</option>
                    <option value="5" v-else selected>Sim</option>
                  </select>
                </div>
                ...
                <div class="mb-3">
                  <label for="nome" class="form-label"
                    >Categoria <span style="opacity: 0.6">(Opcional)</span></label
                  >
