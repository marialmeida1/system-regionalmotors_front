      ...
      <div class="modal-content px-1 px-md-5 px-lg-5">
        <div class="rounded-3" style="box-shadow: 0px -0px 10px -3px rgba(0, 0, 0, 0.3)">
          <div class="text-center py-4 pb-2">
            <router-link to="/" style="width: 100%; display: flex; justify-content: center; padding-bottom: 2rem;">
              <div class="logo bg-succes px-1 d-flex align-items-center" style="width: 240px">
          ...
          <div class="text-center pb-3">
            ...
            <span style="font-size: 14px"> Iniciar Sessao </span>
          </div>
            ...
            <form>
              ...
              <div class="mb-3">
                <button
                  ...
                  @click="goAnuncios"
                >
                  <img src="/regLoader.png" class="caixa2" v-if="loderLogin" /> Iniciar Sessão
                </button>
              </div>
