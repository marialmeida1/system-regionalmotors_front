<template>
<!-- O modal Adicionar -->
<div class="modal fade" id="IDaddTransmissao" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                  <span class="far fa-user py-2 pt-0"></span> <b>Adicionar Transmissao</b>
                </h5>
  ...
  export default {
      ...
      methods: {
        async add() {
          ...
          try {
            const response = await api.adicionarTransmissao(data)
