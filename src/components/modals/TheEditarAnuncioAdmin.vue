                  ...
                  <div class="row">
                    <div class="py-3">
                      ...
                      <select v-model="status_publicacao" class="form-select">
                          <option value="1" v-if="status_publicacao !== '1'">
                            Aguardando
                          </option>
                          <option value="1" v-else selected>
                            Aguardando
                          </option>
                          ...
                          <option value="3" v-else selected>
                            Recusado
                          </option>
                          <option value="4" v-if="status_publicacao !== '4'">
                            Finalizado
                          </option>
                          <option value="4" v-else selected>
                            Finalizado
                          </option>
                          <option value="5" v-if="status_publicacao !== '5'">
                            Vendido
                          </option>
                          <option value="5" v-else selected>
                            Vendido
                          </option>
                          <option value="6" v-if="status_publicacao !== '6'">
                            Bloqueado
                          </option>
                          <option value="6" v-else selected>
                            Bloqueado
                          </option>
                      </select>
                  </div>
                    ...
                    <div class="p-2 pt-0 row mb-2 mt-md-1 mt-lg-1" style="opacity: 0.8;">
                      ...
                      <div>
                        ...
                        <select v-model="tipo_veiculo" class="form-select">
                          <option value="" selected disabled>Selecionar</option>
                          <option v-for="item in $store.state.tipo_veiculo" :value="item.id" :key="item.id">{{ item.tipo_veiculo}}</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="text form-control" id="preco" v-model="valor_preco" @keyup="formatarNumero" placeholder="">
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="p-2 pt-0 row mb-2 mt-md-4 mt-lg-4" style="opacity: 0.8;">
                        <div class="col-7 col-md-5 bg-dark col-lg-5 text-center p-0 py-1" style="border-top-left-radius: 8px; font-size: 13px; background-color: crimson !important;"> 
                          Privilegios
                        </div>
                        <div class="col-5 col-md-7 col-lg-7 p-0" style="padding-top: 13.5px !important;">
                          <div style="background-color: rgba(0, 0, 0, 0.5); padding: 1px;">
                      ...
                      <div class="mb-3"> 
                        <label for="desc" class="form-label">Descriçao <span style="opacity: 0.6;">(Opcional)</span></label>
