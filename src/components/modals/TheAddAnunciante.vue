              ...
              <div class="row">
                ...
                <div class="mb-3">
                  ...
                  <select
                    class="form-select"
                    v-model="estado_id_2"
                    @change="listFilterRegiaoComercial"
                    required
                  >
                ...
                <div class="mb-3">
                  ...
                  <select
                    class="form-select"
                    v-model="regiao_comercial_id"
                    @change="listFilterCidade"
                    required
                  >
                    <option value="0" selected disabled>Selecionar</option>
