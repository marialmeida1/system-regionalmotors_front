<template>
    <div class="bg-white" style="box-shadow: 0px 0px 20px 0px rgba(0,0,0,0.1);">
        <!-- Menu Mobile -->
        ...
        <div class="navegacao d-block d-lg-none fixed-top">
            <header class="header bg-white">
                <div class="logo bg-succes px-3" style="width: 260px; padding: 13.5px 0;">
                    <RouterLink class="routerLink pt-2" :to="`/loja/${hostname_id}`">
                ...
                <div class="icons bg-succes p-2 px-3">
                    ...
                    <div class="icon d-block d-lg-none btn-menu" @click="show_menu"><i class="fas fa-bars"></i></div>
                                ...
                                <div class="items-menu-mobile">
                                    ...
                                    <div class="mb-2" v-if="session">
                                        <h4>
                                            ...
                                            <div style="display: inline-block; width: 15px; height: 15px; background-color: green; border-radius: 100px;">
                                            </div>
                                        ...
                                        <router-link to="/conta">
                                            ...
                                            <span @click="sair" style="cursor: pointer; color: crimson;">
                                                Sair
                                            </span>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="ps-2">
                                        <p class="" @click="execAll('carro')">Carro</p>
                                        <p class="" @click="execAll('moto')">Moto</p>
                                        <!-- <p>Serviços</p> -->
                                    </div>

                                    <h5 class="mt-3">Anunciar</h5>
                                    <div class="ps-2">
                                        <p
                                            type="button" 
                                    ...
                                    <h5 class="mt-3">Mais</h5>
                                    <div class="ps-2">
                                        <p>Serviços</p>
                                        <!-- p>Lojas & concessionarias</p -->
                                        <p>Contatos</p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="navegacao d-none d-lg-block fixed-top">
            <header class="header bg-dark bg-white ps-5">
                <RouterLink class="routerLink py-1" :to="`/loja/${hostname_id}`">
                    <div class="logo bg-success0 ps-4 pt-1 d-flex align-items-center" style="height: 50px;">
                        <img :src="$store.state.fotosAnunciantes.foto" class="img-fluid w-100 h-100">
                    </div>
                ...
                <div id="men" class="bg-inf card-menu" >
                    ...
                    <div class="card-menu-content d-flex align-items-center">
                        <div class="menu-link position-relative py-3">Comprar
                            <div class="sub-menu-desktop position-absolute py-2" style="z-index: 99; width: 170px;">
                                <div class="pb-3"></div>
                                <div class="bg-white px-2 py-3 rounded-3" style="border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                        <p class="" @click="execAll('carro')">Carro</p>
                                        <p class="" @click="execAll('moto')">Moto</p>
                                    <!-- <p>Serviços</p> -->
                                </div>
                        ...
                        <div class="menu-link position-relative py-3">Anunciar
                            <div class="sub-menu-desktop position-absolute py-2" style="z-index: 99; width: 170px;">
                                <div class="pb-3"></div>
                                <div class="bg-white px-2 py-3 rounded-3" style="border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                        ...
                        <div class="menu-link position-relative py-3">Serviços
                        </div>
                        <!-- div class="menu-link position-relative py-3">Lojas & Concessionarias
                        </div -->
                ...
                <div class="icons bg-succes px-3 d-flex align-items-center">
                    <div class="icon"><span style="font-size: 23px;" class="far fa-bell"></span></div>
                    <div class="icon d-none d-lg-block menu-link position-relative py-">
                        <i class="fa fa-user me-2 fa-lg"></i> <span style="font-size: 0.8em;">Conta</span>
                        <div class="sub-menu-desktop position-absolute" style="left: -50px !important;">
                            <div class="py-2" style="z-index: 99; width: 170px;">
                                <div class="pb-2"></div>
                                <div class="bg-white px-1 py-1" style="border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                                    <div class="px-3"
                                    > 
                                    <div v-if="session">
                                        <router-link to="/conta">
                                        ...
                                        <p class="m-0 mb-2" style="text-align: left !important;"
                                            @click="sair"
                                        >Sair</p>
                                    </div>
                    ...
                    <div class="icon invisible"><span style="font-size: 23px;" class="far fa-bell"></span></div>
                    <div class="icon d-block d-lg-none btn-menu"><i class="fas fa-bars"></i></div>
                </div>
...
<script>
    ...
    export default {
        ...
        async created(){
            ...
            if(localStorage.getItem('hostname_id')){
                this.hostname_id = localStorage.getItem('hostname_id') 
            }
