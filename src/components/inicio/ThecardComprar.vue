<template>
    <div>
        <div class="px-2 p-lg-0">
            <div class="card-comprar position-relative shadow-no-top  col-11 col-md-8 col-lg-10 py-2 p-lg-4 mx-auto mb-3 bg-white" style="border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-radius: 8px; box-shadow: -3px 3px 20px rgba(0,0,0,0.1);">

                <div class="p-2 px-4 p-lg-2">
                    <h5 class="card-comprar-text"><span class="luz-card-comprar"></span> <span style="margin-left: 10px;">Encontre um veiculo ou serviço</span></h5>
                </div>
                            ...
                            <div class="contant-main-buscar">
                                <div class="bg-white rounded-3 pt-2" style="height: 350px; overflow: auto; box-shadow: -3px 3px 20px rgba(0,0,0,0.1);" v-if="showBar">
                                    ...
                                    <div class="content-buscar ">
                                        ...
                                        <div>
                                            <ul class="m-0">
                                                <li v-if="listMarcaFiltrada.length > 0" v-for="item in listMarcaFiltrada" class="filteres"
                                    ...
                                    <div class="content-buscar">
                                        <div class="titulo-buscar" style="margin-top: 0;">
                                            Modelos
                                        </div>
                                        <div>
                                            <ul>
                                                <li v-for="item in listModeloFiltrado" class="filteres" v-if="listModeloFiltrado.length > 0"
        ...
        computed: {
            listMarcaFiltrada() {
              ...
              return this.$store.state.marcas.filter(fruta =>
                fruta.nome_marca.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().includes(textoFormatado)
              );
            },
            ...
            listModeloFiltrado() {
              ...
              return this.$store.state.modelos.filter(fruta =>
                fruta.nome_modelo.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().includes(textoFormatado)
              );
            }
        }
