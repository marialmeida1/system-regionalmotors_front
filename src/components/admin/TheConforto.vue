    ...
    <main class="content">
            ...
            <div>
                ...
                <div class="py-2 pt-3 px-2" style="font-size: 13px;">
                    <span class="me-2 p-1 px-2 rounded-3 bg-dark" style="opacity: 0.6;">
                        <b>Admin/Opcionais de Conforto</b>
                    </span> 
                </div>
            </div>
           ...
           <div class="p-2 pt-3 table-responsive" style="height: 65vh;">
            <table class="table">
                ...
                <tbody>
                <tr v-for="categ in $store.state.conforto" :key="categ.id">
                        <th scope="row"> {{ categ.id }} </th>
                        <td> {{ categ.conforto }} </td>
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarConfortoNow"
           ...
           <!-- Editar Conforto -->
           <div class="modal fade" id="EditarConfortoNow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Conforto Now</b>
                            </h5>
                        ...
                        <div class="modal-body" style="height: 470px; overflow: auto; margin-bottom: 1em;">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control" v-model="nome_marca">
                                </div>
...
export default {
  ...
  async created() {
    this.$store.state.conforto = await api.listarConforto()
