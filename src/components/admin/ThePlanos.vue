<template>
    <main class="content">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="plano in $store.state.planos" :key="plano.id">
                        ...
                        <td scope="col"><div style="width: 100px;">R$ {{ plano.valor }}</div></td>
                        ...
                        <td class="text-center">
                            <div style="width: 100px;">
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarPlanoNow"
                                    @click="showgetDados(plano.id)"
                                >
                                ...
                                type="button" 
                                data-bs-toggle="modal" 
                                data-bs-target="#EliminarPlano"
                                @click="modalApagar(plano.id)"
                            ></span>
                            </div>
                        </td>
                    </tr>
           ...
           <!-- Editar Plano -->
           <div class="modal fade" id="EditarPlanoNow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
