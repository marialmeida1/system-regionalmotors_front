    ...
    <main class="content">
        ...
        <div class="position-relative" style="height: 72vh;">
                    ...
                    <tbody>
                        <tr v-for="item in anunciantesFiltradas" :key="item.id">
                            <td class="py-4 pb-5">
                                <div>
                                    <div style="position: relative; ">
                                        ...
                                        <label for="fotoAnunciante" style="position: absolute; bottom: -10px; right: 5px" @click="getIdUpload(item.id)">
                                            <i class="fas fa-camera"></i>
                                        </label>
                                        <input id="fotoAnunciante" type="file" name="" @change="handleFileUpload" class="d-none">
                                    </div>
                                </div>
                            </td>
                            <td class="pt-4"> 
                            ...
                            <td class="pt-4">
                                ...
                                <div v-else style="width: 180px; background-color: rgba(0,0,0,0.5); color: #fff;" class="p-1 rounded-3 text-center"> 
                                    Bloqueado
                                </div>
                            </td>
                            ...
                            <td class="text-center py-4">
                                <div style="width: 150px;">
                                    ...
                                    <span class="fas fa-users ms-3" style="cursor: pointer;" 
                                          data-bs-toggle="modal"
            ...
            <button class="btn btn-add rounded-circle 
                    ...
                    justify-content-center align-items-center" style="left: 8px; z-index: 99;" type="button" data-bs-toggle="modal"
        ...
        <!-- Editar Anunciante  -->
           <div class="modal fade" id="EditarAnunciante" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                      ...
                      <div class="px-">
                        <div class="mb-3">
                            ...
                            <input id="email" type="text" placeholder="Pessoa Responsavel" class="form-control" v-model="Pessoal_responsavel">
                        </div>
                      </div>
                      ...
                      <div class="px-">
                        <div class="mb-3">
                            ...
                            <input id="email" type="text" placeholder="Complemento" class="form-control" v-model="complemento">
                        </div>
                      </div>
                      ...
                      <div class="px-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="Nome" placeholder="Endereco" class="form-control" v-model="endereco_comercial">
                        </div>
                      </div>
                      ...
                      <div class="px-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="Nome" placeholder="Numero" class="form-control" v-model="numero_comercial">
                        </div>
                      </div>
                      ...
                      <div class="px-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="Nome" placeholder="Complemento" class="form-control" v-model="complemento_comercial">
                        </div>
                      </div>
                      ...
                      <div class="px-2">
                        <div class="mb-3">
                            ...
                            <input type="text" id="Nome" placeholder="Bairro" class="form-control" v-model="bairros_comercial">
                        </div>
                      </div>
            ...
            <!-- Eliminar Anunciante -->
            <div class="modal fade" id="EliminarAnunciante" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <div style="display: flex; flex-wrap: wrap;">
                ...
                <div class="col-6">
                    <button v-if="status_plano" type="button" class="ms-3 btn btn-primary" @click="editarPlano()">Actualizar</button>
    ...
    methods: {
        ...
        filterCidade(id) {
          ...
          filterCidadeComercial() {
            // Filtrar os dados onde o ID é igual a 1
            return this.$store.state.cidade.filter(cidade => cidade.id_regiao === this.regiao_comercial_id);
          },
          ...
          async applyFiltro(chaveID, valorID){
            ...
            async handleFileUpload(event) {
              ...
              this.uploadPhoto('foto', this.index)
            },
