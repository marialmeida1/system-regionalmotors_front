                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="height: 470px; overflow: auto; margin-bottom: 1em;">
                            ...
                            <form>
                              ...
                              <div class="" v-if="thumbnailUrl" style="width: 100%; height: 400px; position: relative;">
                                  ...
                                  <div class="col-12" style="position: absolute; top: 0; left: 0;">
                                      <label for="foto_perfil" class="me-2 btn btn-sm btn-primary">
                                          Editar
                                      </label>
                                      <input id="foto_perfil" type="file" name="" @change="handleFileUpload" class="form-control d-none">
                              ...
                              <div v-else v-if="imagem" style="width: 100%; height: 400px; position: relative;">
                                  <img class="img-fluid deApagar custom-image" :src="`${imagem}?v=${new Date().getTime()}`" alt="regional motors">
