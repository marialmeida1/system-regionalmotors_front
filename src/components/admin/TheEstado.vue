    ...
    <main class="content">
           ...
           <div class="p-2 pt-3 table-responsive" style="height: 65vh;">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="categ in $store.state.estado" :key="categ.id">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Estado</b>
                            </h5>
                        ...
                        <div class="modal-body" style="height: 470px; overflow: auto; margin-bottom: 1em;">
                            ...
                            <form>
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="text" class="text form-control" id="nome" v-model="estado_id">
                              </div>
                            </form>
                        </div>
...
export default {
  ...
  methods: {
    ...
    showgetDados(id){
            ...
            this.estado_id = this.estado.estado 
