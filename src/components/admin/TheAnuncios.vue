<template>
    <main class="content m-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10 col-lg-12 p-0">
                                <div class="pesquisar" style="width: 100%; position: relative; border: none;">
                                    <input type="text" class="ps-4 pt-2" style="width: 89%; color: #000;"  v-model="filtro" placeholder="Buscar" > 
                    ...
                    <div class="col-4 bg-inf col-lg-2 pesquisar-mais-relevantes" hidden>
                        <div class="row">
                            ...
                            <div class="sub-menu-desktop mais-relevantes position-absolute py-2" style="z-index: 99; width: 170px; left: -135px !important;">
                                <div class="pb-3"></div>
                                <div class="bg-dark p-2 text-cente" style="border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
        ...
        <div class="px-2 px-lg-3">
            ...
            <div v-if="carregar" style="height: 20vh;" class="d-flex justify-content-center align-items-center">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr v-else v-for="anuncio in $store.state.anuncios" :key="anuncio.id">
                        ...
                        <td> 
                            <span v-if="anuncio.situacao_veiculo == 1">
                                Novo
                            </span> 
                            <span v-if="anuncio.situacao_veiculo == 2">
                                Usado
                            </span> 
                        </td>
                        ...
                        <td>
                            <div name="">
                                <div class="py-2">
                                    <div style="width: 150px;" v-if="anuncio.status_publicacao == 1" class="text-center bg-warning p-2 rounded-3"> 
                                        Aguardando
                                    </div>
                                    <div style="width: 150px; background-color: rgb(0, 221, 0);" v-else-if="anuncio.status_publicacao == 2" class="text-center p-2 rounded-3"> 
                                        Activo
                                    </div>
                                    <div style="width: 150px; color: #fff;" v-else-if="anuncio.status_publicacao == 3" class="text-center bg-danger p-2 rounded-3"> 
                                        Reprovado
                                    </div>
                                    <div style="width: 150px;" v-else-if="anuncio.status_publicacao == 4" class="text-center bg-dark p-2 rounded-3"> 
                                        Finalizado
                                    </div>
                                    <div style="width: 150px; background-color: rgb(0, 214, 221);" v-else-if="anuncio.status_publicacao == 5" class="text-center p-2 rounded-3"> 
                                        Vendido
                                    </div>
                                    <div style="width: 150px; background-color: rgb(168, 168, 168); color: rgb(104, 101, 101);;" v-else-if="anuncio.status_publicacao == 6" class="text-center p-2 rounded-3"> 
                                        Bloqueado
                                    </div> 
                                </div>
                            </div>
           ...
           <!-- Eliminar Anucio -->
            <div class="modal fade" id="EliminarAnuncio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  methods: {
    ...
    async recarregarDados(id) {
        ...
        try {
            ...
            console.log("Foto " + this.$store.state.foto1)
