<template>
    <main class="content">
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarFabricante"
                                ...
                                type="button" 
                                data-bs-toggle="modal" 
                                data-bs-target="#EliminarFabricante"
           ...
           <!-- Editar Fabricante -->
           <div class="modal fade" id="EditarFabricante" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <!-- Eliminar Fabricante -->
            <div class="modal fade" id="EliminarFabricante" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
