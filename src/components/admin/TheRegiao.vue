    ...
    <main class="content">
           ...
           <div class="p-2 pt-3 table-responsive" style="height: 65vh;">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="categ in $store.state.regiao" :key="categ.id">
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarRegiaoNow"
           ...
           <!-- Editar Regiao -->
           <div class="modal fade" id="EditarRegiaoNow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Regiao</b>
                            </h5>
                        ...
                        <div class="modal-body" style="height: 470px; overflow: auto; margin-bottom: 1em;">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control" v-model="novaRegiao">
                                </div>

                                <div class="mb-3">
                                    <label for="nome" class="form-label">Estado</label>
                                    <select v-model="novoEstado_id" class="form-select">
                                        <option :value="estado.id" v-for="estado in Api_estado" :key="estado.id">
                                            {{ estado.estado }}
                                        </option>
                                    </select>
                                </div>
            ...
            <!-- Eliminar estado -->
            <div class="modal fade" id="EliminarRegiao" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel" style="font-size: 17px;">
                              <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Apagar Regiao</b>
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                        </div>
