  ...
  <main class="content m-0">
      ...
      <div class="row">
        ...
        <div class="col-4 bg-inf col-lg-2 pesquisar-mais-relevantes">
          <div class="row">
            ...
            <div class="menu-link position-relative pesquisar-link-icon col-4 pt-3 invisible">
    ...
    <div class="position-relative">
      <div class="p-2 pt-3 table-responsive">
        <!-- Estatisticas -->
        <div class="px-3">
          <div style="font-size: 13px; font-weight: bold">Estatísticas</div>
          <div>
            <table>
              <tr>
                <td>
                  <span style="font-size: 13px" class="pe-2"> Views no anuncio </span>
                </td>
                <td>
                  <span style="font-size: 13px">
                    {{ veiculo.numero_cliques }}
                  </span>
                </td>
              </tr>
              <tr>
                <td>
                  <span style="font-size: 13px" class="pe-2"> Pedidos de contato </span>
                </td>
                <td>
                  <span style="font-size: 13px">
                    {{ veiculo.numero_cliques_contato }}
                  </span>
                </td>
              </tr>
              <tr>
                <td>
                  <span style="font-size: 13px" class="pe-2"> Pedidos de mensagem </span>
                </td>
                <td>
                  <span style="font-size: 13px">
                    {{ veiculo.numero_cliques_mensagem }}
                  </span>
                </td>
              </tr>
            </table>
          ...
          <div class="rounded-3 p-3 mb-" style="box-shadow: 0px 0px 8px 0px rgba(0, 0, 0, 0.2)">
            <div class="mb-2 row">
              ...
              <div class="col-12 col-md-4 col-lg-4 mb-1">
                <p
                  v-if="veiculo.status_publicacao === 1"
                  class="m-0 bg-warning text-center rounded-3"
                  style="opacity: 1; font-size: 15px"
                >
                  Aguardando
                </p>
                <p
                  v-else-if="veiculo.status_publicacao === 2"
                  class="m-0 text-center rounded-3"
                  style="opacity: 1; font-size: 15px; background-color: rgb(0, 214, 221)"
                >
                  Anuncio Ativo
                </p>
                <p
                  v-else-if="veiculo.status_publicacao === 3"
                  class="m-0 bg-danger text-center rounded-3"
                  style="opacity: 1; font-size: 15px; color: #fff"
                >
                  Anuncio foi Reprovado
                </p>
                <p
                  v-else-if="veiculo.status_publicacao === 4"
                  class="m-0 bg-dark text-center rounded-3"
                  style="opacity: 1; font-size: 15px"
                >
                  Anuncio Finalizado
                </p>
              ...
              <div class="">
                <div class="row">
                  ...
                  <div class="col-12 col-md-4 col-lg-4 mb-3">
                    ...
                    <span v-if="veiculo.situacao_veiculo == '1'"> Novo </span>
                  ...
                  <div class="col-12 col-md-4 col-lg-4 mb-3">
                    <p class="mb-1" style="opacity: 0.6; font-size: 15px">Preço</p>
                    {{ veiculo.valor_preco }}
                  </div>

                  <div class="col-12 col-md-4 col-lg-4 mb-3">
                    <p class="mb-1" style="opacity: 0.6; font-size: 15px">Mostrar Preço</p>
                  ...
                  <div class="col-12 col-md-4 col-lg-4 mb-3">
                    <p class="mb-1" style="opacity: 0.6; font-size: 15px">Numero de Portas</p>
                    {{ veiculo.portas }}
                  </div>

                  <div class="col-12 col-md-4 col-lg-4 mb-3">
                    <p class="mb-1" style="opacity: 0.6; font-size: 15px">Transmissao</p>
                    {{ veiculo.transmissao }}
                  </div>
...
export default {
      ...
      menuItems: [
        {
          ...
          isOpen: false,
          inputs: ["Ar condicionado", "Ar quente"],
        },
        {
          label: "Opcionais de Segurança",
          isOpen: false,
          inputs: ["Cinto de Segurança", "Segurança 2", "Segurança 3"],
        },
      ],
      selectedInputs: {
  ...
  methods: {
    ...
    showgetDados() {
      let id = this.$route.query.id;
      this.detalharAnuncios = this.$store.state.anuncios.find(
        (objeto) => objeto.id == parseInt(id)
      );
