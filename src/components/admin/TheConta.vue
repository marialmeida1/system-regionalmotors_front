<template>
    <div>
        ...
        <div class="col-lg-8 col-11 mx-auto">
            ...
            <p class="mb-3 mt-0 titulo-estado" style="position: absolute; top: -5px; left: 25px; opacity: 0.6;">
            ...
            <div class="bg-white p-4 rounded-3 mb-3">
                ...
                <div class="mb-3">
                    <input type="file" name="" class="form-control" @change="handleFileUpload('api/anunciantes/uploadFoto_anuciantes/', $event, 'foto')">
                </div>
                ...
                <div class="mb-3">
                    <input type="file" name="" class="form-control" @change="handleFileUpload('api/anunciantes/banner_loja_anuciantes/', $event, 'banner_loja')">
                </div>
                ...
                <div class="mb-3">
                  <input type="file" name="" class="form-control" @change="handleFileUpload('api/anunciantes/banner_loja_movel_anuciantes/', $event, 'banner_loja_movel')">
                </div>
            </div>
