<template>
    <main class="content">
           ...
           <div class="p-2 pt-3 table-responsive" style="height: 65vh;">
            <table class="table">
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarTransmissao"
                                ...
                                type="button" 
                                data-bs-toggle="modal" 
                                data-bs-target="#EliminarTransmissao"
                ...
                <button class="btn btn-add rounded-circle 
                    ...
                    type="button" 
                    data-bs-toggle="modal" 
                    data-bs-target="#IDaddTransmissao"
                    > 
           ...
           <!-- Editar Transmissao -->
           <div class="modal fade" id="EditarTransmissao" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Transmissao</b>
                            </h5>
            ...
            <div class="modal fade" id="EliminarTransmissao" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel" style="font-size: 17px;">
                              <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Apagar Transmissao</b>
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                        </div>
