<template>
    <main class="content">
            ...
            <div>
                ...
                <div class="py-2 pt-3 px-2" style="font-size: 13px;">
                    <span class="me-2 p-1 px-2 rounded-3 bg-dark" style="opacity: 0.6;">
                        <b>Admin/Opcionais de Segurança</b>
                    </span> 
                </div>
            </div>
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarSegurancaNow"
           ...
           <!-- Editar Segurança -->
           <div class="modal fade" id="EditarSegurancaNow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Segurança Now</b>
                            </h5>
...
export default {
  ...
  computed: {
    anunciosReversos() {
      ...
      return [...this.$store.state.seguranca].reverse();
    }
  },
};
</script>
