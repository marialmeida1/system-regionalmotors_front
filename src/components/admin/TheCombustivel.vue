<template>
    <main class="content">
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarCombustivel"
                                ...
                                type="button" 
                                data-bs-toggle="modal" 
                                data-bs-target="#EliminarCombustivel"
           ...
           <!-- Editar Transmissao -->
           <div class="modal fade" id="EditarCombustivel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal fade" id="EliminarCombustivel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
