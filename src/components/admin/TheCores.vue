    ...
    <main class="content">
           ...
           <div class="p-2 pt-3 table-responsive" style="height: 65vh;">
            <table class="table">
                ...
                <tbody>
                    <tr v-for="categ in $store.state.cores" :key="categ.id">
           ...
           <!-- Editar Cores -->
           <div class="modal fade" id="EditarCores" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Cor</b>
                            </h5>
            ...
            <!-- Eliminar Cores -->
            <div class="modal fade" id="EliminarCores" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel" style="font-size: 17px;">
                              <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Apagar Cor</b>
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                        </div>
