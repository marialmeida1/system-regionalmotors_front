<template>
    <main class="content">
           ...
           <div class="p-2 pt-3 table-responsive" style="height: 65vh;">
            <table class="table">
                        ...
                        <td class="text-center">
                            <div style="width: 100%;">
                                ...
                                <span class="mx-3"
                                    ...
                                    data-bs-target="#EditarTecnologia"
                                ...
                                type="button" 
                                data-bs-toggle="modal" 
                                data-bs-target="#EliminarTecnologia"
                ...
                <button class="btn btn-add rounded-circle 
                    ...
                    type="button" 
                    data-bs-toggle="modal" 
                    data-bs-target="#IDaddTecnologia"
                    > 
           ...
           <!-- Editar Tecnologia -->
           <div class="modal fade" id="EditarTecnologia" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span class="fas fa-bullhorn py-2 pt-0"></span> <b>Editar Tecnologia</b>
                            </h5>
            ...
            <!-- Eliminar Tecnologia -->
            <div class="modal fade" id="EliminarTecnologia" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
