<template>
    <main class="content">
           ...
           <!-- Editar Cidade -->
           <div class="modal fade" id="EditarCidadeNow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <!-- Eliminar Cidade -->
            <div class="modal fade" id="EliminarCidade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
  ...
  methods: {
    ...
    // Carregar as var
        ...
        async listFilterRegiao() {
            console.log("filter edit Região")
        ...
        async filterCidade(valorID) {
            ...
            this.$store.state.cidade = await api.filtrarAnuncio('api/cidade/listar_cidades?regiao_id='+valorID)
